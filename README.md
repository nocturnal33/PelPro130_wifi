...
> I AM NOT RESPONSIBEL FOR ANY DAMAGE TO YOUR PELLET STOVE OR HOUSE.


# Add wifi to your PelPro 130
*This has only been tested on a PelPro 130*

## YOU WILL NEED TO TEST THIS BEFORE RUNNING UNATTENDED
I have had this running for months with no issues. Again, If you don't feel comfortable messing with the controls of you pellet stove - **DON'T DO IT!**
...
![Inside of enclosure](Images/Inside.png)
![Front of enclosure](Images/outside.png)
...
## Home Assistant.
This works great with Home Assistant. I am using my Google Nest to check the inside temperature and turn on the Pellet Stove based on the min and turn off on the max. Lots of ways to do this, but this works for my setup.  
![Home Assistant](Images/HomeAssist.png)
